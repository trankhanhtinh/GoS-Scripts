...
Spells = {
	...
	["YasuoQ"]={charName="Yasuo",slot=_Q,type="linear",speed=math.huge,range=475,delay=0.339,radius=40,hitbox=true,aoe=true,cc=false,collision=false},
	["YasuoQ3"]={charName="Yasuo",slot=_Q,type="linear",speed=1200,range=1000,delay=0.339,radius=90,hitbox=true,aoe=true,cc=true,collision=false},
