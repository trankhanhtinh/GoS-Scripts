...
self.Spells = {
	...
	["AhriOrbofDeception"]={charName="Ahri",slot=_Q,type="linear",displayName="Orb of Deception",killTime=0,speed=2500,range=880,delay=0.25,radius=100,hitbox=true,aoe=true,cc=false,mcollision=false},
	["AhriSeduce"]={charName="Ahri",slot=_E,type="linear",displayName="Charm",killTime=0,speed=1550,range=975,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["BandageToss"]={charName="Amumu",slot=_Q,type="linear",displayName="Bandage Toss",killTime=0,speed=2000,range=1100,delay=0.25,radius=80,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["FlashFrost"]={charName="Anivia",slot=_Q,type="linear",displayName="Flash Frost",killTime=0,speed=850,range=1075,delay=0.25,radius=110,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["EnchantedCrystalArrow"]={charName="Ashe",slot=_R,type="linear",displayName="Enchanted Crystal Arrow",killTime=0,speed=1600,range=25000,delay=0.25,radius=130,hitbox=true,aoe=false,cc=true,mcollision=false},
	["AurelionSolQ"]={charName="AurelionSol",slot=_Q,type="linear",displayName="Starsurge",killTime=0,speed=850,range=1075,delay=0.25,radius=210,hitbox=true,aoe=true,cc=true,mcollision=false},
	["AurelionSolR"]={charName="AurelionSol",slot=_R,type="linear",displayName="Voice of Light",killTime=0,speed=4500,range=1500,delay=0.35,radius=120,hitbox=true,aoe=true,cc=true,mcollision=false},
	["BardQ"]={charName="Bard",slot=_Q,type="linear",displayName="Cosmic Binding",killTime=0,speed=1500,range=950,delay=0.25,radius=60,hitbox=true,aoe=true,cc=true,mcollision=true},
	...
	["RocketGrab"]={charName="Blitzcrank",slot=_Q,type="linear",displayName="Rocket Grab",killTime=0,speed=1800,range=925,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["BrandQ"]={charName="Brand",slot=_Q,type="linear",displayName="Sear",killTime=0,speed=1600,range=1050,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["BraumQ"]={charName="Braum",slot=_Q,type="linear",displayName="Winter's Bite",killTime=0,speed=1700,range=1000,delay=0.25,radius=60,hitbox=true,aoe=true,cc=true,mcollision=true},
	["BraumRWrapper"]={charName="Braum",slot=_R,type="linear",displayName="Glacial Fissure",killTime=0,speed=1400,range=1250,delay=0.5,radius=115,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["CaitlynEntrapmentMissile"]={charName="Caitlyn",slot=_E,type="linear",displayName="90 Caliber Net",killTime=0,speed=1600,range=750,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["CamilleE"]={charName="Camille",slot=_E,type="linear",displayName="Hookshot",killTime=0,speed=1400,range=800,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,mcollision=false},
	...
	["MissileBarrageMissile"]={charName="Corki",slot=_R,type="linear",displayName="Missile Barrage",killTime=0,speed=2000,range=1225,delay=0.175,radius=40,hitbox=true,aoe=false,cc=false,mcollision=true},
	["MissileBarrageMissile2"]={charName="Corki",slot=_R,type="linear",displayName="Missile Barrage",killTime=0,speed=2000,range=1225,delay=0.175,radius=40,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["InfectedCleaverMissileCast"]={charName="DrMundo",slot=_Q,type="linear",displayName="Infected Cleaver",killTime=0,speed=2000,range=975,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,mcollision=true},
	["DravenDoubleShot"]={charName="Draven",slot=_E,type="linear",displayName="Stand Aside",killTime=0,speed=1400,range=1050,delay=0.25,radius=130,hitbox=true,aoe=true,cc=true,mcollision=false},
	["DravenRCast"]={charName="Draven",slot=_R,type="linear",displayName="Whirling Death",killTime=0,speed=2000,range=25000,delay=0.5,radius=160,hitbox=true,aoe=true,cc=false,mcollision=false},
	["EkkoQ"]={charName="Ekko",slot=_Q,type="linear",displayName="Timewinder",killTime=0,speed=1650,range=1075,delay=0.25,radius=120,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["EzrealMysticShot"]={charName="Ezreal",slot=_Q,type="linear",displayName="Mystic Shot",killTime=0,speed=2000,range=1150,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,mcollision=true},
	["EzrealEssenceFlux"]={charName="Ezreal",slot=_W,type="linear",displayName="Essence Flux",killTime=0,speed=1600,range=1000,delay=0.25,radius=80,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["FioraW"]={charName="Fiora",slot=_W,type="linear",displayName="Riposte",killTime=0,speed=3200,range=750,delay=0.75,radius=70,hitbox=true,aoe=true,cc=true,mcollision=false},
	["FizzR"]={charName="Fizz",slot=_R,type="linear",displayName="Chum the Waters",killTime=0,speed=1300,range=1300,delay=0.25,radius=80,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["GnarQ"]={charName="Gnar",slot=_Q,type="linear",displayName="Boomerang Throw",killTime=0,speed=2500,range=1100,delay=0.25,radius=55,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["GravesQLineSpell"]={charName="Graves",slot=_Q,type="linear",displayName="End of the Line",killTime=0,speed=2000,range=925,delay=0.25,radius=20,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["GravesChargeShot"]={charName="Graves",slot=_R,type="linear",displayName="Collateral Damage",killTime=0,speed=2100,range=1000,delay=0.25,radius=100,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["HecarimUlt"]={charName="Hecarim",slot=_R,type="linear",displayName="Onslaught of Shadows",killTime=0,speed=1100,range=1000,delay=0.01,radius=230,hitbox=true,aoe=true,cc=true,mcollision=false},
	["HeimerdingerW"]={charName="Heimerdinger",slot=_W,type="linear",displayName="Hextech Micro-Rockets",killTime=0,speed=2050,range=1325,delay=0.25,radius=60,hitbox=true,aoe=true,cc=false,mcollision=true},
	...
	["IllaoiE"]={charName="Illaoi",slot=_E,type="linear",displayName="Test of Spirit",killTime=0,speed=1900,range=900,delay=0.25,radius=50,hitbox=true,aoe=false,cc=false,mcollision=true},
	["IllaoiR"]={charName="Illaoi",slot=_R,type="circular",displayName="Leap of Faith",killTime=1,speed=math.huge,range=0,delay=0.5,radius=450,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["IreliaR"]={charName="Irelia",slot=_R,type="linear",displayName="Vanguard's Edge",killTime=0,speed=2000,range=1000,delay=0.4,radius=160,hitbox=true,aoe=true,cc=true,mcollision=false},
	["IvernQ"]={charName="Ivern",slot=_Q,type="linear",displayName="Rootcaller",killTime=0,speed=1300,range=1075,delay=0.25,radius=65,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["JayceShockBlast"]={charName="Jayce",slot=_Q,type="linear",displayName="Shock Blast",killTime=0,speed=1450,range=1175,delay=0.214,radius=70,hitbox=true,aoe=true,cc=false,mcollision=true},
	["JayceShockBlastWallMis"]={charName="Jayce",slot=_Q,type="linear",displayName="Shock Blast",killTime=0,speed=2350,range=1900,delay=0.214,radius=115,hitbox=true,aoe=true,cc=false,mcollision=true},
	...
	["JhinE"]={charName="Jhin",slot=_E,type="circular",displayName="Captive Audience",killTime=1,speed=1600,range=750,delay=0.25,radius=120,hitbox=true,aoe=false,cc=true,mcollision=false},
	...
	["JinxW"]={charName="Jinx",slot=_W,type="linear",displayName="Zap!",killTime=0,speed=3300,range=1450,delay=0.6,radius=60,hitbox=true,aoe=false,cc=true,mcollision=true},
	["JinxE"]={charName="Jinx",slot=_E,type="circular",displayName="Flame Chompers!",killTime=1,speed=1100,range=900,delay=1.5,radius=120,hitbox=true,aoe=true,cc=true,mcollision=false},
	["JinxR"]={charName="Jinx",slot=_R,type="linear",displayName="Mega Death Rocket!",killTime=0,speed=1700,range=25000,delay=0.6,radius=140,hitbox=true,aoe=true,cc=false,mcollision=false},
	["KaisaW"]={charName="Kaisa",slot=_W,type="linear",displayName="Void Seeker",killTime=0,speed=1750,range=3000,delay=0.4,radius=100,hitbox=true,aoe=false,cc=false,mcollision=true},
	["KalistaMysticShot"]={charName="Kalista",slot=_Q,type="linear",displayName="Pierce",killTime=0,speed=2400,range=1150,delay=0.35,radius=40,hitbox=true,aoe=false,cc=false,mcollision=true},
	["KarmaQ"]={charName="Karma",slot=_Q,type="linear",displayName="Inner Flame",killTime=0,speed=1700,range=950,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,mcollision=true},
	["KarmaQMantra"]={charName="Karma",slot=_Q,type="linear",displayName="Inner Flame",killTime=0,speed=1700,range=950,delay=0.25,radius=80,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["KennenShurikenHurlMissile1"]={charName="Kennen",slot=_Q,type="linear",displayName="Thundering Shuriken",killTime=0,speed=1700,range=1050,delay=0.175,radius=50,hitbox=true,aoe=false,cc=false,mcollision=true},
	["KhazixW"]={charName="Khazix",slot=_W,type="linear",displayName="Void Spike",killTime=0,speed=1700,range=1000,delay=0.25,radius=70,hitbox=true,aoe=false,cc=false,mcollision=true},
	["KhazixWLong"]={charName="Khazix",slot=_W,type="linear",displayName="Void Spike",killTime=0,speed=1700,range=1000,delay=0.25,radius=70,hitbox=true,aoe=true,cc=true,mcollision=true},
	["KhazixE"]={charName="Khazix",slot=_E,type="circular",displayName="Leap",killTime=0,speed=1000,range=700,delay=0.25,radius=320,hitbox=true,aoe=true,cc=false,mcollision=false},
	["KhazixELong"]={charName="Khazix",slot=_E,type="circular",displayName="Leap",killTime=0,speed=1000,range=900,delay=0.25,radius=320,hitbox=true,aoe=true,cc=false,mcollision=false},
	["KledQ"]={charName="Kled",slot=_Q,type="linear",displayName="Beartrap on a Rope",killTime=0,speed=1600,range=800,delay=0.25,radius=45,hitbox=true,aoe=false,cc=true,mcollision=true},
	["KledRiderQ"]={charName="Kled",slot=_Q,type="conic",displayName="Pocket Pistol",killTime=0,speed=3000,range=700,delay=0.25,angle=25,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["KogMawQ"]={charName="KogMaw",slot=_Q,type="linear",displayName="Caustic Spittle",killTime=0,speed=1650,range=1175,delay=0.25,radius=70,hitbox=true,aoe=false,cc=false,mcollision=true},
	["KogMawVoidOoze"]={charName="KogMaw",slot=_E,type="linear",displayName="Void Ooze",killTime=0,speed=1400,range=1280,delay=0.25,radius=120,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["BlinkMonkQOne"]={charName="LeeSin",slot=_Q,type="linear",displayName="Sonic Wave",killTime=0,speed=1800,range=1200,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["LissandraQ"]={charName="Lissandra",slot=_Q,type="linear",displayName="Ice Shard",killTime=0,speed=2200,range=825,delay=0.251,radius=75,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["LissandraE"]={charName="Lissandra",slot=_E,type="linear",displayName="Glacial Path",killTime=0,speed=850,range=1050,delay=0.25,radius=125,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["LucianW"]={charName="Lucian",slot=_W,type="linear",displayName="Ardent Blaze",killTime=0,speed=1600,range=900,delay=0.25,radius=55,hitbox=true,aoe=true,cc=false,mcollision=false},
	["LucianR"]={charName="Lucian",slot=_R,type="linear",displayName="The Culling",killTime=0,speed=2800,range=1200,delay=0.01,radius=110,hitbox=true,aoe=false,cc=false,mcollision=true},
	["LuluQ"]={charName="Lulu",slot=_Q,type="linear",displayName="Glitterlance",killTime=0,speed=1450,range=925,delay=0.25,radius=60,hitbox=true,aoe=true,cc=true,mcollision=false},
	["LuxLightBinding"]={charName="Lux",slot=_Q,type="linear",displayName="Light Binding",killTime=0,speed=1200,range=1175,delay=0.25,radius=50,hitbox=true,aoe=true,cc=true,mcollision=true},
	...
	["MaokaiQ"]={charName="Maokai",slot=_Q,type="linear",displayName="Bramble Smash",killTime=0,speed=1600,range=600,delay=0.375,radius=110,hitbox=true,aoe=true,cc=true,mcollision=false},
	["MissFortuneScattershot"]={charName="MissFortune",slot=_E,type="circular",displayName="Make It Rain",killTime=1,speed=math.huge,range=1000,delay=0.5,radius=400,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["DarkBindingMissile"]={charName="Morgana",slot=_Q,type="linear",displayName="Dark Binding",killTime=0,speed=1200,range=1175,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["NamiR"]={charName="Nami",slot=_R,type="linear",displayName="Tidal Wave",killTime=0,speed=850,range=2750,delay=0.5,radius=250,hitbox=true,aoe=true,cc=true,mcollision=false},
	["NasusE"]={charName="Nasus",slot=_E,type="circular",displayName="Spirit Fire",killTime=1,speed=math.huge,range=650,delay=0.25,radius=400,hitbox=true,aoe=true,cc=false,mcollision=false},
	["NautilusAnchorDrag"]={charName="Nautilus",slot=_Q,type="linear",displayName="Dredge Line",killTime=0,speed=2000,range=1100,delay=0.25,radius=90,hitbox=true,aoe=false,cc=true,mcollision=true},
	["JavelinToss"]={charName="Nidalee",slot=_Q,type="linear",displayName="Javelin Toss",killTime=0,speed=1300,range=1500,delay=0.25,radius=40,hitbox=true,aoe=true,cc=false,mcollision=true},
	...
	["OlafAxeThrowCast"]={charName="Olaf",slot=_Q,type="linear",displayName="Undertow",killTime=0,speed=1600,range=1000,delay=0.25,radius=90,hitbox=true,aoe=true,cc=true,mcollision=false},
	["OrianaIzunaCommand"]={charName="Orianna",slot=_Q,type="linear",displayName="Command Attack",killTime=0,speed=1400,range=825,delay=0.25,radius=80,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["OrianaRedactCommand"]={charName="Orianna",slot=_E,type="linear",displayName="Command Protect",killTime=0,proj="orianaredact",speed=1400,range=1100,delay=0.25,radius=80,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["OrnnQ"]={charName="Ornn",slot=_Q,type="linear",displayName="Volcanic Rupture",killTime=0,speed=1800,range=800,delay=0.3,radius=65,hitbox=true,aoe=true,cc=true,mcollision=false},
	["OrnnE"]={charName="Ornn",slot=_E,type="linear",displayName="Searing Charge",killTime=0,speed=1800,range=800,delay=0.35,radius=150,hitbox=true,aoe=true,cc=true,mcollision=false},
	["OrnnR"]={charName="Ornn",slot=_R,type="linear",displayName="Call of the Forge God",killTime=0,speed=1650,range=2500,delay=0.5,radius=200,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["PoppyRSpell"]={charName="Poppy",slot=_R,type="linear",displayName="Keeper's Verdict",killTime=0,speed=1600,range=1900,delay=0.333,radius=100,hitbox=true,aoe=true,cc=true,mcollision=false},
	["QuinnQ"]={charName="Quinn",slot=_Q,type="linear",displayName="Blinding Assault",killTime=0,speed=1550,range=1025,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,mcollision=true},
	["RakanQ"]={charName="Rakan",slot=_Q,type="linear",displayName="Gleaming Quill",killTime=0,speed=1850,range=900,delay=0.25,radius=65,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["RekSaiQBurrowed"]={charName="Reksai",slot=_Q,type="linear",displayName="Prey Seeker",killTime=0,speed=1950,range=1650,delay=0.125,radius=65,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["RengarE"]={charName="Rengar",slot=_E,type="linear",displayName="Bola Strike",killTime=0,speed=1500,range=1000,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["RumbleGrenade"]={charName="Rumble",slot=_E,type="linear",displayName="Electro Harpoon",killTime=0,speed=2000,range=850,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,mcollision=true},
	["RumbleCarpetBombDummy"]={charName="Rumble",slot=_R,type="rectangular",displayName="The Equalizer",killTime=0,speed=1600,range=1700,delay=0.583,radius1=600,radius2=200,hitbox=true,aoe=true,cc=true,mcollision=false},
	["RyzeQ"]={charName="Ryze",slot=_Q,type="linear",displayName="Overload",killTime=0,speed=1700,range=1000,delay=0.25,radius=55,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["SejuaniWDummy"]={charName="Sejuani",slot=_W,type="linear",displayName="Winter's Wrath",killTime=0,speed=math.huge,range=600,delay=1,radius=65,hitbox=true,aoe=false,cc=true,mcollision=false},
	["SejuaniR"]={charName="Sejuani",slot=_R,type="linear",displayName="Glacial Prison",killTime=0,speed=1600,range=1300,delay=0.25,radius=120,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["MegaAdhesive"]={charName="Singed",slot=_W,type="circular",displayName="Mega Adhesive",killTime=1,speed=math.huge,range=1000,delay=0.25,radius=265,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["SionE"]={charName="Sion",slot=_E,type="linear",displayName="Roar of the Slayer",killTime=0,speed=1800,range=725,delay=0.25,radius=80,hitbox=false,aoe=true,cc=true,mcollision=false},
	["SivirQ"]={charName="Sivir",slot=_Q,type="linear",displayName="Boomerang Blade",killTime=0,speed=1350,range=1250,delay=0.25,radius=90,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["SonaR"]={charName="Sona",slot=_R,type="linear",displayName="Crescendo",killTime=0,speed=2400,range=900,delay=0.25,radius=140,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["SorakaE"]={charName="Soraka",slot=_E,type="circular",displayName="Equinox",killTime=1,speed=math.huge,range=925,delay=0.25,radius=300,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["SwainE"]={charName="Swain",slot=_E,type="linear",displayName="Nevermove",killTime=0,speed=935,range=850,delay=0.25,radius=85,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["TahmKenchQ"]={charName="TahmKench",slot=_Q,type="linear",displayName="Tongue Lash",killTime=0,speed=2800,range=800,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,mcollision=true},
	["TaliyahQ"]={charName="Taliyah",slot=_Q,type="linear",displayName="Threaded Volley",killTime=0,speed=3600,range=1000,delay=0.25,radius=100,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["TeemoRCast"]={charName="Teemo",slot=_R,type="circular",displayName="Noxious Trap",killTime=1,speed=math.huge,range=900,delay=1.25,radius=200,hitbox=true,aoe=true,cc=true,mcollision=false},
	["ThreshQ"]={charName="Thresh",slot=_Q,type="linear",displayName="Death Sentence",killTime=0,speed=1900,range=1100,delay=0.5,radius=70,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["UrgotR"]={charName="Urgot",slot=_R,type="linear",displayName="Fear Beyond Death",killTime=0,speed=3200,range=1600,delay=0.4,radius=80,hitbox=true,aoe=false,cc=true,mcollision=false},
	["VarusQ"]={charName="Varus",slot=_Q,type="linear",displayName="Piercing Arrow",killTime=0,speed=1900,range=1625,delay=0,radius=70,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["VarusR"]={charName="Varus",slot=_R,type="linear",displayName="Chain of Corruption",killTime=0,speed=1950,range=1075,delay=0.242,radius=120,hitbox=true,aoe=true,cc=true,mcollision=false},
	["VeigarBalefulStrike"]={charName="Veigar",slot=_Q,type="linear",displayName="Baleful Strike",killTime=0,speed=2200,range=950,delay=0.25,radius=70,hitbox=true,aoe=true,cc=false,mcollision=true},
	...
	["VelKozQ"]={charName="VelKoz",slot=_Q,type="linear",displayName="Plasma Fission",killTime=0,speed=1300,range=1050,delay=0.251,radius=50,hitbox=true,aoe=false,cc=true,mcollision=true},
	["VelkozQMissileSplit"]={charName="VelKoz",slot=_Q,type="linear",displayName="Plasma Fission",killTime=0,proj="VelkozQMissileSplit",speed=2100,range=1050,delay=0.251,radius=45,hitbox=true,aoe=false,cc=true,mcollision=true},
	["VelKozW"]={charName="VelKoz",slot=_W,type="linear",displayName="Void Rift",killTime=0,speed=1700,range=1050,delay=0.25,radius=87.5,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["ViQ"]={charName="Vi",slot=_Q,type="linear",displayName="Vault Breaker",killTime=0,speed=1500,range=725,delay=0,radius=90,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["ViktorDeathRay"]={charName="Viktor",slot=_E,type="linear",displayName="Death Ray",killTime=0,speed=1050,range=1025,delay=0,radius=80,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["XayahE"]={charName="Xayah",slot=_E,type="linear",displayName="Bladecaller",killTime=0,speed=4000,range=2000,delay=0,radius=50,hitbox=true,aoe=true,cc=false,mcollision=false},
	["XayahR"]={charName="Xayah",slot=_R,type="conic",displayName="Featherstorm",killTime=0,speed=4000,range=1100,delay=1.5,radius=20,angle=40,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["YasuoQ3W"]={charName="Yasuo",slot=_Q,type="linear",displayName="Gathering Storm",killTime=0,speed=1200,range=1000,delay=0.339,radius=90,hitbox=true,aoe=true,cc=true,mcollision=false},
	["YorickW"]={charName="Yorick",slot=_W,type="annular",displayName="Dark Procession",killTime=1,speed=math.huge,range=600,delay=0.25,radius=300,hitbox=true,aoe=true,cc=true,mcollision=false},
	["ZacQ"]={charName="Zac",slot=_Q,type="linear",displayName="Stretching Strikes",killTime=0,speed=2800,range=800,delay=0.33,radius=80,hitbox=true,aoe=true,cc=true,mcollision=true},
	...
	["ZiggsW"]={charName="Ziggs",slot=_W,type="circular",displayName="Satchel Charge",killTime=1,speed=2000,range=1000,delay=0.25,radius=325,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["ZileanQ"]={charName="Zilean",slot=_Q,type="circular",displayName="Time Bomb",killTime=1,speed=2050,range=900,delay=0.25,radius=180,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["ZoeQ"]={charName="Zoe",slot=_Q,type="linear",displayName="Paddle Star",killTime=0,speed=1200,range=800,delay=0.25,radius=50,hitbox=true,aoe=false,cc=false,mcollision=true},
	["ZoeQRecast"]={charName="Zoe",slot=_Q,type="linear",displayName="Paddle Star",killTime=0,speed=2500,range=1600,delay=0,radius=70,hitbox=true,aoe=false,cc=false,mcollision=true},
	["ZoeE"]={charName="Zoe",slot=_E,type="linear",displayName="Sleepy Trouble Bubble",killTime=0,speed=1700,range=800,delay=0.3,radius=50,hitbox=true,aoe=false,cc=true,mcollision=true},
	...
	["ZyraE"]={charName="Zyra",slot=_E,type="linear",displayName="Grasping Roots",killTime=0,speed=1150,range=1100,delay=0.25,radius=70,hitbox=true,aoe=true,cc=true,mcollision=false},
