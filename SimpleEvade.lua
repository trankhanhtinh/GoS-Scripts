...
self.Spells = {
	...
	["GravesQLineMis"]={charName="Graves",slot=_Q,type="rectangular",killTime=0,speed=math.huge,range=925,delay=0.25,radius2=250,radius=100,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["KarthusLayWasteA1"]={charName="Karthus",slot=_Q,type="circular",killTime=0,speed=math.huge,range=875,delay=0.75,radius=200,hitbox=true,aoe=true,cc=false,mcollision=false},
	["KarthusLayWasteA2"]={charName="Karthus",slot=_Q,type="circular",killTime=0,speed=math.huge,range=875,delay=0.75,radius=200,hitbox=true,aoe=true,cc=false,mcollision=false},
	["KarthusLayWasteA3"]={charName="Karthus",slot=_Q,type="circular",killTime=0,speed=math.huge,range=875,delay=0.75,radius=200,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["LuxMaliceCannon"]={charName="Lux",slot=_R,type="linear",killTime=0,speed=math.huge,range=3340,delay=1.375,radius=115,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["MalzaharQ"]={charName="Malzahar",slot=_Q,type="rectangular",killTime=0,speed=math.huge,range=900,delay=0.25,radius2=400,radius=100,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["ZyraQ"]={charName="Zyra",slot=_Q,type="rectangular",killTime=0,speed=math.huge,range=800,delay=0.625,radius2=400,radius=100,hitbox=true,aoe=true,cc=false,mcollision=false},
