...
self.Spells = {
	...
	["AatroxE"]={charName="Aatrox",slot=_E,type="linear",displayName="Blades of Torment",killTime=0,speed=1250,range=1000,delay=0.25,radius=150,hitbox=true,aoe=true,cc=true,mcollision=false},
	["AhriOrbofDeception"]={charName="Ahri",slot=_Q,type="linear",displayName="Orb of Deception",killTime=0,speed=2500,range=880,delay=0.25,radius=100,hitbox=true,aoe=true,cc=false,collision=false},
	["AhriSeduce"]={charName="Ahri",slot=_E,type="linear",displayName="Charm",killTime=0,speed=1550,range=975,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["BandageToss"]={charName="Amumu",slot=_Q,type="linear",displayName="Bandage Toss",killTime=0,speed=2000,range=1100,delay=0.25,radius=80,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["FlashFrost"]={charName="Anivia",slot=_Q,type="linear",displayName="Flash Frost",killTime=0,speed=850,range=1075,delay=0.25,radius=110,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["EnchantedCrystalArrow"]={charName="Ashe",slot=_R,type="linear",displayName="Enchanted Crystal Arrow",killTime=0,speed=1600,range=25000,delay=0.25,radius=130,hitbox=true,aoe=false,cc=true,collision=false},
	["AurelionSolQ"]={charName="AurelionSol",slot=_Q,type="linear",displayName="Starsurge",killTime=0,speed=850,range=1075,delay=0.25,radius=210,hitbox=true,aoe=true,cc=true,collision=false},
	["AurelionSolR"]={charName="AurelionSol",slot=_R,type="linear",displayName="Voice of Light",killTime=0,speed=4500,range=1500,delay=0.35,radius=120,hitbox=true,aoe=true,cc=true,collision=false},
	["BardQ"]={charName="Bard",slot=_Q,type="linear",displayName="Cosmic Binding",killTime=0,speed=1500,range=950,delay=0.25,radius=60,hitbox=true,aoe=true,cc=true,collision=true},
	...
	["RocketGrab"]={charName="Blitzcrank",slot=_Q,type="linear",displayName="Rocket Grab",killTime=0,speed=1800,range=925,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["BrandQ"]={charName="Brand",slot=_Q,type="linear",displayName="Sear",killTime=0,speed=1600,range=1050,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["BraumQ"]={charName="Braum",slot=_Q,type="linear",displayName="Winter's Bite",killTime=0,speed=1700,range=1000,delay=0.25,radius=60,hitbox=true,aoe=true,cc=true,collision=true},
	["BraumRWrapper"]={charName="Braum",slot=_R,type="linear",displayName="Glacial Fissure",killTime=0,speed=1400,range=1250,delay=0.5,radius=115,hitbox=true,aoe=true,cc=true,collision=false},
	["CaitlynPiltoverPeacemaker"]={charName="Caitlyn",slot=_Q,type="linear",displayName="Piltover Peacemaker",killTime=0,speed=2200,range=1250,delay=0.625,radius=90,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["CaitlynEntrapmentMissile"]={charName="Caitlyn",slot=_E,type="linear",displayName="90 Caliber Net",killTime=0,speed=1600,range=750,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["CamilleE"]={charName="Camille",slot=_E,type="linear",displayName="Hookshot",killTime=0,speed=1400,range=800,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,collision=false},
	...
	["MissileBarrageMissile"]={charName="Corki",slot=_R,type="linear",displayName="Missile Barrage",killTime=0,speed=2000,range=1225,delay=0.175,radius=40,hitbox=true,aoe=false,cc=false,collision=true},
	["MissileBarrageMissile2"]={charName="Corki",slot=_R,type="linear",displayName="Missile Barrage",killTime=0,speed=2000,range=1225,delay=0.175,radius=40,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["InfectedCleaverMissileCast"]={charName="DrMundo",slot=_Q,type="linear",displayName="Infected Cleaver",killTime=0,speed=2000,range=975,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,collision=true},
	["DravenDoubleShot"]={charName="Draven",slot=_E,type="linear",displayName="Stand Aside",killTime=0,speed=1400,range=1050,delay=0.25,radius=130,hitbox=true,aoe=true,cc=true,collision=false},
	["DravenRCast"]={charName="Draven",slot=_R,type="linear",displayName="Whirling Death",killTime=0,speed=2000,range=25000,delay=0.5,radius=160,hitbox=true,aoe=true,cc=false,collision=false},
	["EkkoQ"]={charName="Ekko",slot=_Q,type="linear",displayName="Timewinder",killTime=0,speed=1650,range=1075,delay=0.25,radius=120,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["EliseHumanE"]={charName="Elise",slot=_E,type="linear",displayName="Cocoon",killTime=0,speed=1600,range=1075,delay=0.25,radius=55,hitbox=true,aoe=false,cc=true,collision=true},
	["EvelynnQ"]={charName="Evelynn",slot=_Q,type="linear",displayName="Hate Spike",killTime=0,speed=2200,range=800,delay=0.25,radius=35,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["EzrealMysticShot"]={charName="Ezreal",slot=_Q,type="linear",displayName="Mystic Shot",killTime=0,speed=2000,range=1150,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,collision=true},
	["EzrealEssenceFlux"]={charName="Ezreal",slot=_W,type="linear",displayName="Essence Flux",killTime=0,speed=1600,range=1000,delay=0.25,radius=80,hitbox=true,aoe=true,cc=false,collision=false},
	["EzrealTrueshotBarrage"]={charName="Ezreal",slot=_R,type="linear",displayName="Trueshot Barrage",killTime=0,speed=2000,range=25000,delay=1,radius=160,hitbox=true,aoe=true,cc=false,collision=false},
	["FioraW"]={charName="Fiora",slot=_W,type="linear",displayName="Riposte",killTime=0,speed=3200,range=750,delay=0.75,radius=70,hitbox=true,aoe=true,cc=true,collision=false},
	["FizzR"]={charName="Fizz",slot=_R,type="linear",displayName="Chum the Waters",killTime=0,speed=1300,range=1300,delay=0.25,radius=80,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["GnarQ"]={charName="Gnar",slot=_Q,type="linear",displayName="Boomerang Throw",killTime=0,speed=2500,range=1100,delay=0.25,radius=55,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["GnarBigQ"]={charName="Gnar",slot=_Q,type="linear",displayName="Boulder Toss",killTime=0,speed=2100,range=1100,delay=0.5,radius=90,hitbox=true,aoe=true,cc=true,collision=true},
	...
	["GravesQLineSpell"]={charName="Graves",slot=_Q,type="linear",displayName="End of the Line",killTime=0,speed=2000,range=925,delay=0.25,radius=20,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["GravesChargeShot"]={charName="Graves",slot=_R,type="linear",displayName="Collateral Damage",killTime=0,speed=2100,range=1000,delay=0.25,radius=100,hitbox=true,aoe=true,cc=false,collision=false},
	["GravesChargeShotFxMissile"]={charName="Graves",slot=_R,type="conic",displayName="Collateral Damage",killTime=0,speed=math.huge,range=800,delay=0.3,radius=20,angle=80,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["HecarimUlt"]={charName="Hecarim",slot=_R,type="linear",displayName="Onslaught of Shadows",killTime=0,speed=1100,range=1000,delay=0.01,radius=230,hitbox=true,aoe=true,cc=true,collision=false},
	["HeimerdingerW"]={charName="Heimerdinger",slot=_W,type="linear",displayName="Hextech Micro-Rockets",killTime=0,speed=2050,range=1325,delay=0.25,radius=60,hitbox=true,aoe=true,cc=false,collision=true},
	...
	["IllaoiE"]={charName="Illaoi",slot=_E,type="linear",displayName="Test of Spirit",killTime=0,speed=1900,range=900,delay=0.25,radius=50,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["IreliaW2"]={charName="Irelia",slot=_W,type="circular",displayName="Defiant Dance",killTime=0.25,speed=math.huge,range=0,delay=0,radius=275,hitbox=false,aoe=true,cc=false,mcollision=false},
	["IreliaW2"]={charName="Irelia",slot=_W,type="linear",displayName="Defiant Dance",killTime=0.25,speed=math.huge,range=825,delay=0.25,radius=90,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["IreliaR"]={charName="Irelia",slot=_R,type="linear",displayName="Vanguard's Edge",killTime=0,speed=2000,range=1000,delay=0.4,radius=160,hitbox=true,aoe=true,cc=true,collision=false},
	["IvernQ"]={charName="Ivern",slot=_Q,type="linear",displayName="Rootcaller",killTime=0,speed=1300,range=1075,delay=0.25,radius=65,hitbox=true,aoe=false,cc=true,collision=true},
	["HowlingGale"]={charName="Janna",slot=_Q,type="linear",displayName="Howling Gale",killTime=0,speed=667,range=1750,delay=0,radius=100,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["JayceShockBlast"]={charName="Jayce",slot=_Q,type="linear",displayName="Shock Blast",killTime=0,speed=1450,range=1175,delay=0.214,radius=70,hitbox=true,aoe=true,cc=false,collision=true},
	["JayceShockBlastWallMis"]={charName="Jayce",slot=_Q,type="linear",displayName="Shock Blast",killTime=0,speed=2350,range=1900,delay=0.214,radius=115,hitbox=true,aoe=true,cc=false,collision=true},
	...
	["JhinE"]={charName="Jhin",slot=_E,type="circular",displayName="Captive Audience",killTime=2,speed=1600,range=750,delay=0.25,radius=120,hitbox=true,aoe=false,cc=true,collision=false},
	["JhinRShot"]={charName="Jhin",slot=_R,type="linear",displayName="Curtain Call",killTime=0,speed=5000,range=3500,delay=0.25,radius=80,hitbox=true,aoe=false,cc=true,collision=false},
	["JinxW"]={charName="Jinx",slot=_W,type="linear",displayName="Zap!",killTime=0,speed=3300,range=1450,delay=0.6,radius=60,hitbox=true,aoe=false,cc=true,collision=true},
	["JinxE"]={charName="Jinx",slot=_E,type="circular",displayName="Flame Chompers!",killTime=1.5,speed=1100,range=900,delay=1.5,radius=120,hitbox=true,aoe=true,cc=true,collision=false},
	["JinxR"]={charName="Jinx",slot=_R,type="linear",displayName="Mega Death Rocket!",killTime=0,speed=1700,range=25000,delay=0.6,radius=140,hitbox=true,aoe=true,cc=false,collision=false},
	["KaisaW"]={charName="Kaisa",slot=_W,type="linear",displayName="Void Seeker",killTime=0,speed=1750,range=3000,delay=0.4,radius=100,hitbox=true,aoe=false,cc=false,collision=true},
	["KalistaMysticShot"]={charName="Kalista",slot=_Q,type="linear",displayName="Pierce",killTime=0,speed=2400,range=1150,delay=0.35,radius=40,hitbox=true,aoe=false,cc=false,collision=true},
	["KarmaQ"]={charName="Karma",slot=_Q,type="linear",displayName="Inner Flame",killTime=0,speed=1700,range=950,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,collision=true},
	["KarmaQMantra"]={charName="Karma",slot=_Q,type="linear",displayName="Inner Flame",killTime=0,speed=1700,range=950,delay=0.25,radius=80,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["KaynW"]={charName="Kayn",slot=_W,type="linear",displayName="Blade's Reach",killTime=0,speed=math.huge,range=700,delay=0.55,radius=90,hitbox=true,aoe=true,cc=true,collision=false},
	["KennenShurikenHurlMissile1"]={charName="Kennen",slot=_Q,type="linear",displayName="Thundering Shuriken",killTime=0,speed=1700,range=1050,delay=0.175,radius=50,hitbox=true,aoe=false,cc=false,collision=true},
	["KhazixW"]={charName="Khazix",slot=_W,type="linear",displayName="Void Spike",killTime=0,speed=1700,range=1000,delay=0.25,radius=70,hitbox=true,aoe=false,cc=false,collision=true},
	["KhazixWLong"]={charName="Khazix",slot=_W,type="linear",displayName="Void Spike",killTime=0,speed=1700,range=1000,delay=0.25,radius=70,hitbox=true,aoe=true,cc=true,collision=true},
	["KhazixE"]={charName="Khazix",slot=_E,type="circular",displayName="Leap",killTime=0,speed=1000,range=700,delay=0.25,radius=320,hitbox=true,aoe=true,cc=false,collision=false},
	["KhazixELong"]={charName="Khazix",slot=_E,type="circular",displayName="Leap",killTime=0,speed=1000,range=900,delay=0.25,radius=320,hitbox=true,aoe=true,cc=false,collision=false},
	["KledQ"]={charName="Kled",slot=_Q,type="linear",displayName="Beartrap on a Rope",killTime=0,speed=1600,range=800,delay=0.25,radius=45,hitbox=true,aoe=false,cc=true,collision=true},
	["KledRiderQ"]={charName="Kled",slot=_Q,type="conic",displayName="Pocket Pistol",killTime=0,speed=3000,range=700,delay=0.25,angle=25,hitbox=false,aoe=true,cc=false,collision=false},
	["KledEDash"]={charName="Kled",slot=_E,type="linear",displayName="Jousting",killTime=0,speed=1100,range=550,delay=0,radius=90,hitbox=true,aoe=true,cc=false,collision=false},
	["KogMawQ"]={charName="KogMaw",slot=_Q,type="linear",displayName="Caustic Spittle",killTime=0,speed=1650,range=1175,delay=0.25,radius=70,hitbox=true,aoe=false,cc=false,collision=true},
	["KogMawVoidOoze"]={charName="KogMaw",slot=_E,type="linear",displayName="Void Ooze",killTime=0,speed=1400,range=1280,delay=0.25,radius=120,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["LeBlancE"]={charName="LeBlanc",slot=_E,type="linear",displayName="Ethereal Chains",killTime=0,speed=1750,range=925,delay=0.25,radius=55,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["LeBlancRE"]={charName="LeBlanc",slot=_E,type="linear",displayName="Ethereal Chains",killTime=0,speed=1750,range=925,delay=0.25,radius=55,hitbox=true,aoe=false,cc=true,collision=true},
	["BlinkMonkQOne"]={charName="LeeSin",slot=_Q,type="linear",displayName="Sonic Wave",killTime=0,speed=1800,range=1200,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["LeonaZenithBlade"]={charName="Leona",slot=_E,type="linear",displayName="Zenith Blade",killTime=0,speed=2000,range=875,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,collision=false},
	...
	["LissandraQ"]={charName="Lissandra",slot=_Q,type="linear",displayName="Ice Shard",killTime=0,speed=2200,range=825,delay=0.251,radius=75,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["LissandraE"]={charName="Lissandra",slot=_E,type="linear",displayName="Glacial Path",killTime=0,speed=850,range=1050,delay=0.25,radius=125,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["LucianW"]={charName="Lucian",slot=_W,type="linear",displayName="Ardent Blaze",killTime=0,speed=1600,range=900,delay=0.25,radius=55,hitbox=true,aoe=true,cc=false,collision=false},
	["LucianR"]={charName="Lucian",slot=_R,type="linear",displayName="The Culling",killTime=0,speed=2800,range=1200,delay=0.01,radius=110,hitbox=true,aoe=false,cc=false,collision=true},
	["LuluQ"]={charName="Lulu",slot=_Q,type="linear",displayName="Glitterlance",killTime=0,speed=1450,range=925,delay=0.25,radius=60,hitbox=true,aoe=true,cc=true,collision=false},
	["LuxLightBinding"]={charName="Lux",slot=_Q,type="linear",displayName="Light Binding",killTime=0,speed=1200,range=1175,delay=0.25,radius=50,hitbox=true,aoe=true,cc=true,collision=true},
	["LuxLightStrikeKugel"]={charName="Lux",slot=_E,type="circular",displayName="Lucent Singularity",killTime=0,speed=1300,range=1000,delay=0.25,radius=350,hitbox=true,aoe=true,cc=true,collision=false},
	["LuxMaliceCannon"]={charName="Lux",slot=_R,type="linear",displayName="Final Spark",killTime=0,speed=math.huge,range=3340,delay=1.375,radius=120,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["MaokaiQ"]={charName="Maokai",slot=_Q,type="linear",displayName="Bramble Smash",killTime=0,speed=1600,range=600,delay=0.375,radius=110,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["DarkBindingMissile"]={charName="Morgana",slot=_Q,type="linear",displayName="Dark Binding",killTime=0,speed=1200,range=1175,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["NamiR"]={charName="Nami",slot=_R,type="linear",displayName="Tidal Wave",killTime=0,speed=850,range=2750,delay=0.5,radius=250,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["NautilusAnchorDrag"]={charName="Nautilus",slot=_Q,type="linear",displayName="Dredge Line",killTime=0,speed=2000,range=1100,delay=0.25,radius=90,hitbox=true,aoe=false,cc=true,collision=true},
	["JavelinToss"]={charName="Nidalee",slot=_Q,type="linear",displayName="Javelin Toss",killTime=0,speed=1300,range=1500,delay=0.25,radius=40,hitbox=true,aoe=true,cc=false,collision=true},
	...
	["NocturneDuskbringer"]={charName="Nocturne",slot=_Q,type="linear",displayName="Duskbringer",killTime=0,speed=1600,range=1200,delay=0.25,radius=60,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["OlafAxeThrowCast"]={charName="Olaf",slot=_Q,type="linear",displayName="Undertow",killTime=0,speed=1600,range=1000,delay=0.25,radius=90,hitbox=true,aoe=true,cc=true,collision=false},
	["OrianaIzunaCommand"]={charName="Orianna",slot=_Q,type="linear",displayName="Command Attack",killTime=0,speed=1400,range=825,delay=0.25,radius=80,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["OrianaRedactCommand"]={charName="Orianna",slot=_E,type="linear",displayName="Command Protect",killTime=0,proj="orianaredact",speed=1400,range=1100,delay=0.25,radius=80,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["OrnnQ"]={charName="Ornn",slot=_Q,type="linear",displayName="Volcanic Rupture",killTime=0,speed=1800,range=800,delay=0.3,radius=65,hitbox=true,aoe=true,cc=true,collision=false},
	["OrnnE"]={charName="Ornn",slot=_E,type="linear",displayName="Searing Charge",killTime=0,speed=1800,range=800,delay=0.35,radius=150,hitbox=true,aoe=true,cc=true,collision=false},
	["OrnnR"]={charName="Ornn",slot=_R,type="linear",displayName="Call of the Forge God",killTime=0,speed=1650,range=2500,delay=0.5,radius=200,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["PoppyQSpell"]={charName="Poppy",slot=_Q,type="linear",displayName="Hammer Shock",killTime=0,speed=math.huge,range=430,delay=1.32,radius=85,hitbox=true,aoe=true,cc=true,collision=false},
	["PoppyRSpell"]={charName="Poppy",slot=_R,type="linear",displayName="Keeper's Verdict",killTime=0,speed=1600,range=1900,delay=0.333,radius=100,hitbox=true,aoe=true,cc=true,collision=false},
	["QuinnQ"]={charName="Quinn",slot=_Q,type="linear",displayName="Blinding Assault",killTime=0,speed=1550,range=1025,delay=0.25,radius=60,hitbox=true,aoe=false,cc=false,collision=true},
	["RakanQ"]={charName="Rakan",slot=_Q,type="linear",displayName="Gleaming Quill",killTime=0,speed=1850,range=900,delay=0.25,radius=65,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["RekSaiQBurrowed"]={charName="Reksai",slot=_Q,type="linear",displayName="Prey Seeker",killTime=0,speed=1950,range=1650,delay=0.125,radius=65,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["RengarE"]={charName="Rengar",slot=_E,type="linear",displayName="Bola Strike",killTime=0,speed=1500,range=1000,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["RumbleGrenade"]={charName="Rumble",slot=_E,type="linear",displayName="Electro Harpoon",killTime=0,speed=2000,range=850,delay=0.25,radius=60,hitbox=true,aoe=false,cc=true,collision=true},
	["RumbleCarpetBombDummy"]={charName="Rumble",slot=_R,type="rectangular",displayName="The Equalizer",killTime=0,speed=1600,range=1700,delay=0.583,radius1=600,radius2=200,hitbox=true,aoe=true,cc=true,collision=false},
	["RyzeQ"]={charName="Ryze",slot=_Q,type="linear",displayName="Overload",killTime=0,speed=1700,range=1000,delay=0.25,radius=55,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["SejuaniWDummy"]={charName="Sejuani",slot=_W,type="linear",displayName="Winter's Wrath",killTime=0,speed=math.huge,range=600,delay=1,radius=65,hitbox=true,aoe=false,cc=true,collision=false},
	["SejuaniR"]={charName="Sejuani",slot=_R,type="linear",displayName="Glacial Prison",killTime=0,speed=1600,range=1300,delay=0.25,radius=120,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["SionE"]={charName="Sion",slot=_E,type="linear",displayName="Roar of the Slayer",killTime=0,speed=1800,range=725,delay=0.25,radius=80,hitbox=false,aoe=true,cc=true,collision=false},
	["SivirQ"]={charName="Sivir",slot=_Q,type="linear",displayName="Boomerang Blade",killTime=0,speed=1350,range=1250,delay=0.25,radius=90,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["SkarnerFracture"]={charName="Skarner",slot=_E,type="linear",displayName="Fracture",killTime=0,speed=1500,range=1000,delay=0.25,radius=70,hitbox=true,aoe=true,cc=true,collision=false},
	["SonaR"]={charName="Sona",slot=_R,type="linear",displayName="Crescendo",killTime=0,speed=2400,range=900,delay=0.25,radius=140,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["SwainE"]={charName="Swain",slot=_E,type="linear",displayName="Nevermove",killTime=0,speed=935,range=850,delay=0.25,radius=85,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["SyndraEMissile"]={charName="Syndra",slot=_E,type="linear",displayName="Scatter the Weak",killTime=0,speed=1600,range=1250,delay=0.25,radius=60,hitbox=true,aoe=true,cc=true,mcollision=false},
	["TahmKenchQ"]={charName="TahmKench",slot=_Q,type="linear",displayName="Tongue Lash",killTime=0,speed=2800,range=800,delay=0.25,radius=70,hitbox=true,aoe=false,cc=true,collision=true},
	["TaliyahQ"]={charName="Taliyah",slot=_Q,type="linear",displayName="Threaded Volley",killTime=0,speed=3600,range=1000,delay=0.25,radius=100,hitbox=true,aoe=false,cc=false,collision=true},
	...
	["ThreshQ"]={charName="Thresh",slot=_Q,type="linear",displayName="Death Sentence",killTime=0,speed=1900,range=1100,delay=0.5,radius=70,hitbox=true,aoe=false,cc=true,collision=true},
	["ThreshEFlay"]={charName="Thresh",slot=_E,type="linear",displayName="Flay",killTime=0,proj="ThreshEMissile1",speed=math.huge,range=400,delay=0.389,radius=110,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["WildCards"]={charName="TwistedFate",slot=_Q,type="linear",displayName="Wild Cards",killTime=0,speed=1000,range=1450,delay=0.25,radius=40,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["UrgotE"]={charName="Urgot",slot=_E,type="linear",displayName="Disdain",killTime=0,speed=1050,range=475,delay=0.45,radius=100,hitbox=true,aoe=true,cc=true,collision=false},
	["UrgotR"]={charName="Urgot",slot=_R,type="linear",displayName="Fear Beyond Death",killTime=0,speed=3200,range=1600,delay=0.4,radius=80,hitbox=true,aoe=false,cc=true,collision=false},
	["VarusQ"]={charName="Varus",slot=_Q,type="linear",displayName="Piercing Arrow",killTime=0,speed=1900,range=1625,delay=0,radius=70,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["VarusR"]={charName="Varus",slot=_R,type="linear",displayName="Chain of Corruption",killTime=0,speed=1950,range=1075,delay=0.242,radius=120,hitbox=true,aoe=true,cc=true,collision=false},
	["VeigarBalefulStrike"]={charName="Veigar",slot=_Q,type="linear",displayName="Baleful Strike",killTime=0,speed=2200,range=950,delay=0.25,radius=70,hitbox=true,aoe=true,cc=false,collision=true},
	...
	["VelKozQ"]={charName="VelKoz",slot=_Q,type="linear",displayName="Plasma Fission",killTime=0,speed=1300,range=1050,delay=0.251,radius=50,hitbox=true,aoe=false,cc=true,collision=true},
	["VelkozQMissileSplit"]={charName="VelKoz",slot=_Q,type="linear",displayName="Plasma Fission",killTime=0,proj="VelkozQMissileSplit",speed=2100,range=1050,delay=0.251,radius=45,hitbox=true,aoe=false,cc=true,collision=true},
	["VelKozW"]={charName="VelKoz",slot=_W,type="linear",displayName="Void Rift",killTime=0,speed=1700,range=1050,delay=0.25,radius=87.5,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["ViQ"]={charName="Vi",slot=_Q,type="linear",displayName="Vault Breaker",killTime=0,speed=1500,range=725,delay=0,radius=90,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["ViktorDeathRay"]={charName="Viktor",slot=_E,type="linear",displayName="Death Ray",killTime=0,speed=1050,range=1025,delay=0,radius=80,hitbox=true,aoe=true,cc=false,collision=false},
	...
	["XayahE"]={charName="Xayah",slot=_E,type="linear",displayName="Bladecaller",killTime=0,speed=4000,range=2000,delay=0,radius=50,hitbox=true,aoe=true,cc=false,collision=false},
	["XayahR"]={charName="Xayah",slot=_R,type="conic",displayName="Featherstorm",killTime=0,speed=4000,range=1100,delay=1.5,radius=20,angle=40,hitbox=false,aoe=true,cc=false,collision=false},
	...
	["YasuoQ2W"]={charName="Yasuo",slot=_Q,type="linear",displayName="Steel Wind Rising",killTime=0,speed=math.huge,range=475,delay=0.339,radius=40,hitbox=true,aoe=true,cc=false,mcollision=false},
	["YasuoQ3W"]={charName="Yasuo",slot=_Q,type="linear",displayName="Gathering Storm",killTime=0,speed=1200,range=1000,delay=0.339,radius=90,hitbox=true,aoe=true,cc=true,collision=false},
	...
	["ZacQ"]={charName="Zac",slot=_Q,type="linear",displayName="Stretching Strikes",killTime=0,speed=2800,range=800,delay=0.33,radius=80,hitbox=true,aoe=true,cc=true,collision=true},
	...
	["ZedW"]={charName="Zed",slot=_W,type="linear",displayName="Living Shadow",killTime=0,speed=1750,range=650,delay=0.25,radius=60,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["ZoeQ"]={charName="Zoe",slot=_Q,type="linear",displayName="Paddle Star",killTime=0,speed=1200,range=800,delay=0.25,radius=50,hitbox=true,aoe=false,cc=false,collision=true},
	["ZoeQRecast"]={charName="Zoe",slot=_Q,type="linear",displayName="Paddle Star",killTime=0,speed=2500,range=1600,delay=0,radius=70,hitbox=true,aoe=false,cc=false,collision=true},
	["ZoeE"]={charName="Zoe",slot=_E,type="linear",displayName="Sleepy Trouble Bubble",killTime=0,speed=1700,range=800,delay=0.3,radius=50,hitbox=true,aoe=false,cc=true,collision=true},
	...
	["ZyraE"]={charName="Zyra",slot=_E,type="linear",displayName="Grasping Roots",killTime=0,speed=1150,range=1100,delay=0.25,radius=70,hitbox=true,aoe=true,cc=true,collision=false},
