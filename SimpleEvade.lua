...
self.Spells = {
	...
	["Rupture"]={charName="ChoGath",slot=_Q,type="circular",displayName="Rupture",killTime=0,speed=math.huge,range=950,delay=0.5,radius=175,hitbox=true,aoe=true,cc=true,mcollision=false},
