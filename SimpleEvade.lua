...
self.Spells = {
	...
	["Incinerate"]={charName="Annie",slot=_W,type="conic",killTime=0,speed=math.huge,range=600,delay=0.25,angle=50,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["CamilleW"]={charName="Camille",slot=_W,type="conic",killTime=0,speed=math.huge,range=610,delay=0.75,angle=80,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["CassiopeiaR"]={charName="Cassiopeia",slot=_R,type="conic",killTime=0,speed=math.huge,range=825,delay=0.5,angle=80,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["FeralScream"]={charName="ChoGath",slot=_W,type="conic",killTime=0,speed=math.huge,range=650,delay=0.5,angle=60,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["DariusAxeGrabCone"]={charName="Darius",slot=_E,type="conic",killTime=0,speed=math.huge,range=535,delay=0.25,angle=50,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["EvelynnR"]={charName="Evelynn",slot=_R,type="conic",killTime=0,speed=math.huge,range=450,delay=0.35,angle=180,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["GravesChargeShotFxMissile"]={charName="Graves",slot=_R,type="conic",killTime=0,speed=math.huge,range=800,delay=0.3,angle=80,hitbox=true,aoe=true,cc=false,mcollision=false},
	["HecarimRapidSlash"]={charName="Hecarim",slot=_Q,type="circular",killTime=0,speed=math.huge,range=0,delay=0,radius=350,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["HeimerdingerW"]={charName="Heimerdinger",slot=_W,type="linear",killTime=0,speed=2050,range=1325,delay=0.25,radius=70,hitbox=true,aoe=true,cc=false,mcollision=true},
	...
	["ForcePulse"]={charName="Kassadin",slot=_E,type="conic",killTime=0,speed=math.huge,range=600,delay=0.25,angle=80,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["KledRiderQ"]={charName="Kled",slot=_Q,type="conic",killTime=0,speed=math.huge,range=700,delay=0.25,angle=25,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["Bushwhack"]={charName="Nidalee",slot=_W,type="circular",killTime=2,speed=math.huge,range=900,delay=0.25,radius=85,hitbox=true,aoe=false,cc=false,mcollision=true},
	...
	["Swipe"]={charName="Nidalee",slot=_E,type="conic",killTime=0,speed=math.huge,range=300,delay=0.25,angle=180,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["PantheonE"]={charName="Pantheon",slot=_E,type="conic",killTime=0,speed=math.huge,range=0,delay=0.389,angle=80,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["RivenIzunaBlade"]={charName="Riven",slot=_R,type="conic",killTime=0,speed=1600,range=900,delay=0.25,angle=50,hitbox=true,aoe=true,cc=false,mcollision=false},
	...
	["SejuaniW"]={charName="Sejuani",slot=_W,type="conic",killTime=0,speed=math.huge,range=600,delay=0.25,angle=75,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["SionQ"]={charName="Sion",slot=_Q,type="linear",killTime=0,speed=math.huge,range=600,delay=0,radius=300,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["SwainQ"]={charName="Swain",slot=_Q,type="conic",killTime=0,speed=math.huge,range=725,delay=0.25,angle=45,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["SyndraE"]={charName="Syndra",slot=_E,type="conic",killTime=0,speed=2500,range=700,delay=0.25,angle=40,hitbox=false,aoe=true,cc=true,mcollision=false},
	...
	["TaliyahE"]={charName="Taliyah",slot=_E,type="conic",killTime=0,speed=2000,range=800,delay=0.25,angle=80,hitbox=true,aoe=true,cc=true,mcollision=false},
	["TalonW"]={charName="Talon",slot=_W,type="conic",killTime=0,speed=1850,range=650,delay=0.25,angle=35,hitbox=true,aoe=true,cc=true,mcollision=false},
	...
	["XayahE"]={charName="Xayah",slot=_E,type="linear",killTime=0,speed=5700,range=2000,delay=0,radius=45,hitbox=true,aoe=true,cc=false,mcollision=false},
	["XayahR"]={charName="Xayah",slot=_R,type="conic",killTime=0,speed=4400,range=1100,delay=1.5,angle=40,hitbox=false,aoe=true,cc=false,mcollision=false},
	...
	["XinZhaoW"]={charName="XinZhao",slot=_W,type="conic",killTime=0,speed=math.huge,range=125,delay=0,angle=180,hitbox=false,aoe=true,cc=false,mcollision=false},
